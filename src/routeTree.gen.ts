...
import { ServerRoute as ApiRegistryServerRouteImport } from './routes/api/registry'
...
const ApiRegistryServerRoute = ApiRegistryServerRouteImport.update({
  id: '/api/registry',
  path: '/api/registry',
  getParentRoute: () => rootServerRouteImport,
} as any)
...
export interface FileServerRoutesByFullPath {
  '/api/registry': typeof ApiRegistryServerRoute
...
export interface FileServerRouteTypes {
  ...
  fullPaths: '/api/registry' | '/api/users' | '/api/users/$userId'
  fileServerRoutesByTo: FileServerRoutesByTo
  to: '/api/registry' | '/api/users' | '/api/users/$userId'
  id: '__root__' | '/api/registry' | '/api/users' | '/api/users/$userId'
  fileServerRoutesById: FileServerRoutesById
}
export interface RootServerRouteChildren {
  ApiRegistryServerRoute: typeof ApiRegistryServerRoute
...
declare module '@tanstack/react-start/server' {
  interface ServerFileRoutesByPath {
    ...
    '/api/registry': {
      ...
      preLoaderRoute: typeof ApiRegistryServerRouteImport
      parentRoute: typeof rootServerRouteImport
    }
    '/api/users/$userId': {
      id: '/api/users/$userId'
...
const rootServerRouteChildren: RootServerRouteChildren = {
  ApiRegistryServerRoute: ApiRegistryServerRoute,
